...
var ExpenseCategoriesPageModule = /** @class */ (function () {
    function ExpenseCategoriesPageModule() {
    }
    ExpenseCategoriesPageModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
                FormsModule,
...
export { ExpenseCategoriesPageModule };
